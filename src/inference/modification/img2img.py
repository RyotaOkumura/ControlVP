...
def main(
    ...
    # データセットから画像とエッジを読み込む
    dataset = load_from_disk("/srv/datasets3/HoliCity/dataset_w_vpts_edges")
    input_image = dataset[dataset_num]["image"]
    # image_path = "/home/okumura/lab/vanishing_point/base.png"
    # input_image = Image.open(image_path)
    edges = dataset[dataset_num]["edge"]
    ...
    if edges:  # エッジが存在する場合
        for vp_edges in edges:
            for i in range(0, len(vp_edges), 4):
                ...
                cv2.line(
                    condition_image, (x1, y1), (x2, y2), (0, 0, 0), 1
                )  # 黒線で描画
    conditioning_image = Image.fromarray(condition_image)
...
if __name__ == "__main__":
    # model_name = "/home/okumura/lab/vanishing_point/src/model_out_w_vpts_edges_v-pred/checkpoint-50000/controlnet"
    model_name = "/home/okumura/lab/vanishing_point/ckpt/model_out_w_vpts_edges/checkpoint-130000/controlnet"
