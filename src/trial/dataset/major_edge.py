...
def handle(image_path, nrml_path, prefix):
    ...
    for idx, cnt in zip(unique, counts):
        ...
        for contour in contours:
            ...
            # print(f"0,0,0: {contour[0, 0, 0]}")
            contours_list.append(contour * 8)
    ...
    # cv2.drawContours(img_with_contours, contours_list, -1, (255, 0, 0), 2)
    ...
    # plt.savefig(f"{prefix}_contours.png")
    ...
    for n, cnt in vpts:
        ...
        for contour in contours_list:
            ...
            for i in range(len(contour)):
                ...
                if angle < math.radians(10):  # 閾値は調整可能
                    contour_points.append([current, next_point])
...
if __name__ == "__main__":
    image_path = "/srv/datasets3/HoliCity/images/2008-07/8heFyix0weuW7Kzd6A_BLg_LD_030_41_imag.jpg"
    nrml_path = "/srv/datasets3/HoliCity/normal_map/2008-07/8heFyix0weuW7Kzd6A_BLg_LD_030_41_nrml.npz"
    prefix = "8heFyix0weuW7Kzd6A_BLg_LD_030_41"
    handle(image_path, nrml_path, prefix)
